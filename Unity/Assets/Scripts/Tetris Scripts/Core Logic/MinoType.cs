...
namespace Tetris
{
	...
	public class MinoType
	{
		...
		public BlockColor BlockColor { get { return color; } }

		public MinoType (Point[] Offsets, Point[][] KickOffsets, BlockColor BlockColor, Point Center, int Scale = 1)
		{
		...
		public MinoType (Point[] Offsets, Point[][] KickOffsets, BlockColor BlockColor, int Scale = 1)
